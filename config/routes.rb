Rails.application.routes.draw do
  ...
  # /roll/1/6
  get("/roll/1/6", { :controller => "dice", :action => "six_sided_once"})
  # /roll/2/6
  get("roll/2/6", { :controller => "dice", :action => "six_sided_twice"})
  # /roll/3/6
  get("roll/3/6", { :controller => "dice", :action => "six_sided_3x"})
  # /roll/4/6
  get("roll/4/6", { :controller => "dice", :action => "six_sided_4x"})
  # /roll/5/6
  get("roll/5/6", { :controller => "dice", :action => "six_sided_5x"})
  # /roll/6/6
  get("roll/6/6", { :controller => "dice", :action => "six_sided_6x"})
  # /roll/1/4
  # /roll/2/4
  # /roll/3/4
  # /roll/4/4
